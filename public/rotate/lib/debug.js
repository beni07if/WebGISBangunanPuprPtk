L.Rotate = {
        ...
        <table class="leaflet-rotate-info">
          <tr>
            ...
            <td>
             ...
             <a href=""><img src="img/icon.png" alt="Snow" class="icon" title="Penanda Lokasi"></a>
             <a href=""><img src="img/2.png" alt="Snow" title="Pengukuran"></a>
             <a href=""><img src="img/3.png" alt="Snow"title="Cetak" ></a>
             <a href=""><img src="img/4.png" alt="Snow"title="Swipe Vertikal" ></a>
             <a href=""><img src="img/5.png" alt="Snow" title="Swipe Scope"></a>
            </td>
          </tr>
          <tr>
            <th>LatLng </th>
    ...
    logMouse: function(e) {
        document.getElementById('llx').innerHTML = e.latlng.lng +' Derajat';
        document.getElementById('lly').innerHTML = e.latlng.lat +' Derajat';
