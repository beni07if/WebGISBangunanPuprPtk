...
<ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Edit Bangunan</a>
    </li>
</ul>
        ...
        <div class="card-body">
            <div class="col-md-8">
                ...
                <div class="card card-info">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('bangunan1.update', $bgn->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="bangunan" value="{{$bgn->bangunan}}" id="bangunan" placeholder="Bangunan">
                                </div>
                            </div>
                        </div>
